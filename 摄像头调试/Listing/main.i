...
#line 23 "..\\..\\User\\main.c"
#line 1 "..\\..\\User\\./key/bsp_key.h"




#line 6 "..\\..\\User\\./key/bsp_key.h"
...
#line 24 "..\\..\\User\\main.c"
#line 1 "..\\..\\User\\./systick/bsp_SysTick.h"



#line 5 "..\\..\\User\\./systick/bsp_SysTick.h"
...
{		
	...
	uint16_t ball_flags[3] = {10, 19, 10};
	uint16_t error_scale = 3;
	uint16_t cnt = 0;
	uint8_t tmpres = 0;
	...
	LCD_SetColors(0xF800,0x0000);

  ILI9341_Clear(0,0,LCD_X_LENGTH,LCD_Y_LENGTH);	 
	
	 
  ILI9341_DispStringLine_EN(((0) * (((sFONT *)LCD_GetFont())->Height)),"BH OV7725 Test Demo");
	...
	while(OV7725_Init() != SUCCESS)
	{
		...
		if(retry>5)
		{
			ILI9341_DispStringLine_EN(((2) * (((sFONT *)LCD_GetFont())->Height)),"No OV7725 module detected!");
			while(1);
		}
	}
	...
	ILI9341_DispStringLine_EN(((2) * (((sFONT *)LCD_GetFont())->Height)),"OV7725 initialize success!");
	...
	while(1)
	{
		...
		if( Ov7725_vsync == 2 )
		{
			do{ ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BRR =((uint16_t)0x0004); ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->BRR =((uint16_t)0x0020); ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->BSRR =((uint16_t)0x0020); ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR =((uint16_t)0x0004); ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->BRR =((uint16_t)0x0020); ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->BSRR =((uint16_t)0x0020); }while(0);  			 					
			tmpres = ImagDisp(cam_mode.lcd_sx,
								cam_mode.lcd_sy,
								cam_mode.cam_width,
								cam_mode.cam_height,
								ball_flags, error_scale, &cnt);			 
			Ov7725_vsync = 0;
		}
		if(tmpres == 1) {
			Get_PingPangRIGHT();
