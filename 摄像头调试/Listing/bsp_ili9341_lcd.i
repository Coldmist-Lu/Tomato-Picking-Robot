#line 1 "..\\..\\User\\lcd\\bsp_ili9341_lcd.c"
...
#line 18 "..\\..\\User\\lcd\\bsp_ili9341_lcd.c"
#line 19 "..\\..\\User\\lcd\\bsp_ili9341_lcd.c"



uint16_t LCD_X_LENGTH = 240;
uint16_t LCD_Y_LENGTH = 320;
...
static uint16_t               ILI9341_Read_PixelData      ( void );
 ...
 void ILI9341_Write_Cmd ( uint16_t usCmd )
{
	* ( volatile uint16_t * ) ( ( ( uint32_t ) 0x60000000 ) ) = usCmd;
 ...
 void ILI9341_Write_Data ( uint16_t usData )
{
	* ( volatile uint16_t * ) ( ( ( uint32_t ) 0x60020000 ) ) = usData;
 ...
 uint16_t ILI9341_Read_Data ( void )
{
	return ( * ( volatile uint16_t * ) ( ( ( uint32_t ) 0x60020000 ) ) );
...
static void ILI9341_GPIO_Config ( void )
{
	...
	RCC_APB2PeriphClockCmd ( 	
													...
													((uint32_t)0x00000020)|((uint32_t)0x00000020)|((uint32_t)0x00000020)|
													((uint32_t)0x00000020)	|((uint32_t)0x00000020)|((uint32_t)0x00000040)|
													 
													((uint32_t)0x00000020)|((uint32_t)0x00000020)|	((uint32_t)0x00000020) | 
													((uint32_t)0x00000020) | ((uint32_t)0x00000040)|((uint32_t)0x00000040)|
													((uint32_t)0x00000040) | ((uint32_t)0x00000040)|((uint32_t)0x00000040)|
													((uint32_t)0x00000040) | ((uint32_t)0x00000040)|((uint32_t)0x00000040)|
													((uint32_t)0x00000040) | ((uint32_t)0x00000020)|((uint32_t)0x00000020)|
...
static void ILI9341_FSMC_Config ( void )
{
	...
	readWriteTiming.FSMC_AccessMode            = ((uint32_t)0x10000000);	
...
{
	if ( enumState )
		GPIO_ResetBits ( ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400)), ((uint16_t)0x1000) );	
	else
...
void ILI9341_Rst ( void )
{			
	GPIO_ResetBits ( ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0002) );	 

	ILI9341_Delay ( 0xAFF ); 					   

	GPIO_SetBits ( ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0002) );		 	 
