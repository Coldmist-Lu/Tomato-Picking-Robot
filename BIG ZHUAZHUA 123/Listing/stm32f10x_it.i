...
void EXTI3_IRQHandler ( void )
{
    if ( EXTI_GetITStatus(((uint32_t)0x00008)) != RESET ) 	
    {
        if( Ov7725_vsync == 0 )
        {
            ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->BRR =((uint16_t)0x0010); 	                      
            ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400))->BSRR =((uint16_t)0x0008);	                        
            
            Ov7725_vsync = 1;	   	
            ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400))->BSRR =((uint16_t)0x0008);                          
            ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->BSRR =((uint16_t)0x0010);                        
        }
        else if( Ov7725_vsync == 1 )
        {
            ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400))->BRR =((uint16_t)0x0008);                          
            Ov7725_vsync = 2;
        }        
