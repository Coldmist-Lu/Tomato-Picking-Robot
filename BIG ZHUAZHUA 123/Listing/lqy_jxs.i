#line 1 "..\\..\\User\\lqy_jxs.c"
#line 1 "..\\..\\User\\./lqy_jxs.h"
...
#line 5 "..\\..\\User\\./lqy_jxs.h"

void delay(int cnt);
void ZhuaZhua_Init();
void Get_PingPangRIGHT();
void Get_PingPangLEFT();

#line 2 "..\\..\\User\\lqy_jxs.c"
...
void ZhuaZhua_Init() {
	delay(0xafffff);
	GENERAL_TIM_CH3_CHANGE(6);
	GENERAL_TIM_CH4_CHANGE(15);
	delay(0xfffff);
	GENERAL_TIM_CH1_CHANGE(5);
	GENERAL_TIM_CH2_CHANGE(5);
}
...
void Get_PingPangRIGHT() {
	...
	GENERAL_TIM_CH4_CHANGE(5);
	delay(0xffffff);
	GENERAL_TIM_CH3_CHANGE(6);
	delay(0x1fffff);
	GENERAL_TIM_CH3_CHANGE(10);		
	delay(0xffffff);
	GENERAL_TIM_CH1_CHANGE(12);		
	GENERAL_TIM_CH2_CHANGE(11);
	delay(0x6fffff);
	GENERAL_TIM_CH3_CHANGE(4);		
	delay(0x6fffff);
	GENERAL_TIM_CH1_CHANGE(5);		
	GENERAL_TIM_CH2_CHANGE(5);
	delay(0x6fffff);
