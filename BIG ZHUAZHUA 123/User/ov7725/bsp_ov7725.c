...
/**
	橙色识别函数
**/
uint8_t color_check(uint16_t tmp[]) {
...
/**
  ...
  * @retval 无
  */
uint8_t ImagDisp1(uint16_t sx, uint16_t sy, uint16_t width, uint16_t height, uint16_t H, uint16_t red_point_cnt)
{
	uint16_t i, j;
